...
import { Badge, Button, Card, Divider, Input, Popconfirm, Space, Table, Tooltip } from 'antd'
import {
...
const columns: ColumnsType<DataType> = [
    ...
    },
    {
        ...
        dataIndex: 'last_updated',
        key: 'last_updated',
        render: () => <Badge status="success" text="xxxxxxxx" />,
    },
    {
        width: 1,
        key: 'action',
        ...
        <>
            <Card size="small">
                <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                    <Space>
                        <Input size="small" suffix={<SearchOutlined />} placeholder="Search" />
                    </Space>
