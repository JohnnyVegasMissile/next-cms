                        ...
                        <Col span={6}>
                            <Card title="Containers" size="small">
                                <Space direction="vertical" style={{ width: '100%' }}>
                                    ...
                                    <Divider style={{ margin: 0 }} />
                                    <Checkbox value={RightType.CREATE_CONTAINER}>Create containers</Checkbox>
                                    <Checkbox value={RightType.UPDATE_ALL_CONTAINER}>
                                        Update containers
                                    </Checkbox>
                                    <Checkbox value={RightType.DELETE_CONTAINER}>Delete containers</Checkbox>
                                    <Divider style={{ margin: 0 }} />
                        ...
                        <Col span={6}>
                            <Card title="Contents" size="small">
                                <Space direction="vertical" style={{ width: '100%' }}>
                                    ...
                                    <Checkbox value={RightType.UPDATE_ALL_CONTENT}>Update contents</Checkbox>
                                    <Checkbox value={RightType.DELETE_CONTENT}>Delete contents</Checkbox>
                                    <Divider style={{ margin: 0 }} />
                        ...
                        <Col span={6}>
                            <Card title="Forms" size="small">
                                <Space direction="vertical" style={{ width: '100%' }}>
                                    ...
                                    <Checkbox value={RightType.UPDATE_ALL_FORM}>Update forms</Checkbox>
                                    <Checkbox value={RightType.DELETE_FORM}>Delete forms</Checkbox>
                                </Space>
                            </Card>
                        </Col>
                        <Col span={6}>
                            <Card title="Messages" size="small">
                                <Space direction="vertical" style={{ width: '100%' }}>
                                    <Checkbox value={RightType.VIEW_MESSAGE}>View all messages</Checkbox>
                                    <Divider style={{ margin: 0 }} />
                                    <Checkbox value={RightType.READ_MESSAGE}>Read messages</Checkbox>
                                    <Checkbox value={RightType.DELETE_MESSAGE}>Delete messages</Checkbox>
                                </Space>
                            </Card>
                        </Col>
                        <Col span={6}>
                            <Card title="Users" size="small">
                                <Space direction="vertical" style={{ width: '100%' }}>
                                    <Checkbox value={RightType.VIEW_USER}>View all users</Checkbox>
                                    <Divider style={{ margin: 0 }} />
                                    <Checkbox value={RightType.CREATE_USER}>Create users</Checkbox>
                                    <Checkbox value={RightType.UPDATE_USER}>Update users</Checkbox>
                                    <Checkbox value={RightType.DELETE_USER}>Delete users</Checkbox>
                                </Space>
                            </Card>
                        </Col>
                        <Col span={6}>
                            <Card title="Roles" size="small">
                                <Space direction="vertical" style={{ width: '100%' }}>
                                    <Checkbox value={RightType.VIEW_ROLE}>View all roles</Checkbox>
                                    <Divider style={{ margin: 0 }} />
                                    <Checkbox value={RightType.CREATE_ROLE}>Create roles</Checkbox>
                                    <Checkbox value={RightType.UPDATE_ROLE}>Update roles</Checkbox>
                                    <Checkbox value={RightType.DELETE_ROLE}>Delete roles</Checkbox>
                                </Space>
                            </Card>
                        </Col>
                        <Col span={6}>
                            <Card title="Layout" size="small">
                                <Space direction="vertical" style={{ width: '100%' }}>
                                    ...
                                    <Checkbox value={RightType.UPDATE_LAYOUT}>Update layout</Checkbox>
                                </Space>
                            </Card>
                        </Col>
                        <Col span={6}>
                            <Card title="Settings" size="small">
                                <Space direction="vertical" style={{ width: '100%' }}>
                                    <Checkbox value={RightType.VIEW_SETTING}>View settings</Checkbox>
                                    <Divider style={{ margin: 0 }} />
                                    <Checkbox value={RightType.UPDATE_GENERAL}>Update general</Checkbox>
                                    <Checkbox value={RightType.UPDATE_THEME}>Update theme</Checkbox>
