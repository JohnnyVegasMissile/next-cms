...
const languages: LanguagesType = {
    ...
    EO: { familly: 'Constructed', name: 'Lingvo Internacia', en: 'Esperanto', code: 'eo' },
    ET: { familly: 'Uralic', name: '', en: 'Estonian', code: 'et' },
    FO: { familly: 'Indo-European', name: 'Eesti keel', en: 'Faeroese', code: 'fo' },
    FA: { familly: 'Indo-European', name: 'فارسی', en: 'Farsi', code: 'fa' },
    FJ: { familly: 'Austronesian', name: 'Vosa Vaka-Viti', en: 'Fiji', code: 'fj' },
    FI: { familly: 'Uralic', name: 'Suomi', en: 'Finnish', code: 'fi' },
    FR: { familly: 'Indo-European', name: 'Français', en: 'French', code: 'fr' },
    FY: { familly: 'Indo-European', name: 'Fräisk', en: 'Frisian', code: 'fy' },
    GD: { familly: 'Indo-European', name: 'Gàidhlig', en: 'Gaelic (Scottish)', code: 'gd' },
    GV: { familly: 'Indo-European', name: 'Gaelg', en: 'Gaelic (Manx)', code: 'gv' },
    GL: { familly: 'Indo-European', name: 'Galego', en: 'Galician', code: 'gl' },
    KA: { familly: 'South Caucasian', name: 'ქართული ენა', en: 'Georgian', code: 'ka' },
    DE: { familly: 'Indo-European', name: 'Deutsch', en: 'German', code: 'de' },
    EL: { familly: 'Indo-European', name: 'ελληνικά', en: 'Greek', code: 'el' },
    KL: { familly: 'Eskimo-Aleut', name: 'Kalaallisut', en: 'Greenlandic', code: 'kl' },
    GN: { familly: 'Tupian', name: 'Avañeʼẽa', en: 'Guarani', code: 'gn' },
    GU: { familly: 'Indo-European', name: 'ગુજરાતી', en: 'Gujarati', code: 'gu' },
    HT: { familly: 'Creole', name: 'Kreyòl ayisyen', en: 'Haitian Creole', code: 'ht' },
    HA: { familly: 'Afro-Asiatic', name: 'هَرْشَن هَوْسَ', en: 'Hausa', code: 'ha' },
    HE: { familly: 'Afro-Asiatic', name: 'עִבְרִית', en: 'Hebrew', code: 'he' },
    HI: { familly: 'Indo-European', name: 'हिन्दी', en: 'Hindi', code: 'hi' },
    HU: { familly: 'Uralic', name: 'Magyar nyelv', en: 'Hungarian', code: 'hu' },
    IS: { familly: 'Indo-European', name: 'Íslenska', en: 'Icelandic', code: 'is' },
    IO: { familly: 'Constructed', name: 'Ido', en: 'Ido', code: 'io' },
    ID: { familly: 'Austronesian', name: 'Bahasa Indonesia', en: 'Indonesian', code: 'id' },
    IA: { familly: 'Constructed', name: 'Interlingua', en: 'Interlingua', code: 'ia' },
    IE: { familly: 'Constructed', name: 'Interlingue', en: 'Interlingue', code: 'ie' },
    IU: { familly: 'Eskimo-Aleut', name: 'ᐃᓄᒃᑎᑐᑦ', en: 'Inuktitut', code: 'iu' },
    IK: { familly: 'Eskimo-Aleut', name: 'Uqausiq', en: 'Inupiak', code: 'ik' },
    GA: { familly: 'Indo-European', name: 'Gaeilge', en: 'Irish', code: 'ga' },
    IT: { familly: 'Indo-European', name: 'Italiano', en: 'Italian', code: 'it' },
    JA: { familly: 'Japonic', name: '日本語', en: 'Japanese', code: 'ja' },
    JV: { familly: 'Austronesian', name: 'ꦧꦱꦗꦮ', en: 'Javanese', code: 'jv' },
