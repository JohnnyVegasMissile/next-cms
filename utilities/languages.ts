...
const languages: LanguagesType = {
    ...
    SQ: { name: 'Shqiptare', code: 'sq', en: 'Albanian' },
    AR: { name: 'عربي', code: 'ar', en: 'Arabic' },
    EU: { name: 'Euskara', code: 'eu', en: 'Basque' },
    BE: { name: 'беларускі', code: 'be', en: 'Belarusian' },
    BG: { name: 'български', code: 'bg', en: 'Bulgarian' },
    CA: { name: 'Català', code: 'ca', en: 'Catalan' },
    ZH: { name: '中文', code: 'zh', en: 'Chinese' },
    HR: { name: 'Hrvatski', code: 'hr', en: 'Croatian' },
