...
export const openGraph = [
    { value: 'og:title', label: 'Title', props: (e: string) => ({ content: e }) },
    { value: 'og:type', label: 'Type', props: (e: string) => ({ content: e }) },
    { value: 'og:url', label: 'URL', props: (e: string) => ({ content: e }) },
    { value: 'og:image', label: 'Image', props: (e: string) => ({ content: e }) },
    { value: 'og:site_name', label: 'Site name', props: (e: string) => ({ content: e }) },
    { value: 'og:description', label: 'Description', props: (e: string) => ({ content: e }) },
    { value: 'fb:page_id', label: 'Page ID (Facebook)', props: (e: string) => ({ content: e }) },
    { value: 'og:email', label: 'Email', props: (e: string) => ({ content: e }) },
    { value: 'og:phone_number', label: 'Phone number', props: (e: string) => ({ content: e }) },
    { value: 'og:fax_number', label: 'Fax number', props: (e: string) => ({ content: e }) },
    { value: 'og:latitude', label: 'Latitude', props: (e: string) => ({ content: e }) },
    { value: 'og:longitude', label: 'Longitude', props: (e: string) => ({ content: e }) },
    {
        value: 'og:street-address',
        label: 'Street address',
        props: (e: string) => ({ content: e }),
    },
    { value: 'og:locality', label: 'Locality', props: (e: string) => ({ content: e }) },
    { value: 'og:region', label: 'Region', props: (e: string) => ({ content: e }) },
    { value: 'og:postal-code', label: 'Postal code', props: (e: string) => ({ content: e }) },
    { value: 'og:country-name', label: 'Country name', props: (e: string) => ({ content: e }) },
    { value: 'og:type', label: 'Type', props: (e: string) => ({ content: e }) },
    { value: 'og:points', label: 'Points', props: (e: string) => ({ content: e }) },
    { value: 'og:video', label: 'Video', props: (e: string) => ({ content: e }) },
    { value: 'og:video:height', label: 'Video height', props: (e: string) => ({ content: e }) },
    { value: 'og:video:width', label: 'Video width', props: (e: string) => ({ content: e }) },
    { value: 'og:video:type', label: 'Video type', props: (e: string) => ({ content: e }) },
    { value: 'og:audio', label: 'Audio', props: (e: string) => ({ content: e }) },
    { value: 'og:audio:title', label: 'Audio title', props: (e: string) => ({ content: e }) },
    { value: 'og:audio:artist', label: 'Audio artist', props: (e: string) => ({ content: e }) },
    { value: 'og:audio:album', label: 'Audio album', props: (e: string) => ({ content: e }) },
    { value: 'og:audio:type', label: 'Audio type', props: (e: string) => ({ content: e }) },
]
...
export const apple = [
    ...
    { value: 'apple-touch-icon', label: 'Icon', props: (e: string) => ({ content: e }) },
    {
        value: 'apple-touch-startup-image',
        label: 'Startup image',
        props: (e: string) => ({ content: e }),
...
export const links = [
    { value: 'alternate', label: 'Alternate', props: (e: string) => ({ content: e }) },
    { value: 'shortcut icon', label: 'Shortcut icon', props: (e: string) => ({ content: e }) },
    { value: 'fluid-icon', label: 'Fluid icon', props: (e: string) => ({ content: e }) },
    { value: 'me', label: 'Me', props: (e: string) => ({ content: e }) },
    { value: 'shortlink', label: 'Shortlink', props: (e: string) => ({ content: e }) },
    { value: 'archives', label: 'Archives', props: (e: string) => ({ content: e }) },
    { value: 'index', label: 'Index', props: (e: string) => ({ content: e }) },
    { value: 'start', label: 'Start', props: (e: string) => ({ content: e }) },
    { value: 'prev', label: 'Prev', props: (e: string) => ({ content: e }) },
    { value: 'next', label: 'Next', props: (e: string) => ({ content: e }) },
    { value: 'search', label: 'Search', props: (e: string) => ({ content: e }) },
    { value: 'self', label: 'Self', props: (e: string) => ({ content: e }) },
    { value: 'first', label: 'First', props: (e: string) => ({ content: e }) },
    { value: 'previous', label: 'Previous', props: (e: string) => ({ content: e }) },
    { value: 'last', label: 'Last', props: (e: string) => ({ content: e }) },
    { value: 'shortlink', label: 'Shortlink', props: (e: string) => ({ content: e }) },
    { value: 'canonical', label: 'Canonical', props: (e: string) => ({ content: e }) },
    { value: 'EditURI', label: 'Edit URI', props: (e: string) => ({ content: e }) },
    { value: 'pingback', label: 'Pingback', props: (e: string) => ({ content: e }) },
]
